...
class TestScopedEnumTemplate:
    def test_scoped_enum_no_export_values(self, pybind11_cfg):
        enum = TIREnum(name="Status", qualified_name="ns::Status", is_scoped=True, values=[TIREnumValue("Active", 0)])
    ...
    def test_unscoped_enum_has_export_values(self, pybind11_cfg):
        enum = TIREnum(name="Dir", qualified_name="ns::Dir", is_scoped=False, values=[TIREnumValue("North", 0)])
        out = _gen(TIRModule(name="m", enums=[enum]), pybind11_cfg)
...
class TestStaticFieldTemplate:
    def _static_cls(self, read_only: bool = False):
        f = TIRField(name="kMax", type_spelling="int", is_static=True, is_const=read_only, read_only=read_only)
        return TIRClass(name="Cfg", qualified_name="ns::Cfg", namespace="ns", variable_name="classCfg", fields=[f])
...
class TestAnonymousEnumTemplate:
    def test_anonymous_enum_pybind11_uses_attr(self, pybind11_cfg):
        enum = TIREnum(
            name="__anon_enum_17",
            qualified_name="ns::__anon_enum_17",
            is_anonymous=True,
...
class TestConversionOperatorTemplate:
    def _conv_cls(self, op_type: str, target_type: str):
        ...
        return TIRClass(
            name="Wrapper", qualified_name="ns::Wrapper", namespace="ns", variable_name="classWrapper", methods=[method]
        )
...
class TestDeprecatedAnnotationsTemplate:
    def _deprecated_method_cls(self):
        m = TIRMethod(
            ...
            return_type="void",
            is_deprecated=True,
            deprecation_message="use newMethod",
        )
        return TIRClass(name="Foo", qualified_name="ns::Foo", namespace="ns", variable_name="classFoo", methods=[m])
    ...
    def test_deprecated_enum_luals(self, luals_cfg):
        enum = TIREnum(
            name="OldEnum",
            qualified_name="ns::OldEnum",
            is_deprecated=True,
            deprecation_message="use NewEnum",
    ...
    def test_deprecated_class_luals(self, luals_cfg):
        cls = TIRClass(
            name="OldClass",
            qualified_name="ns::OldClass",
            namespace="ns",
            variable_name="classOldClass",
            is_deprecated=True,
            deprecation_message="use NewClass",
        )
...
class TestArithmeticEnum:
    ...
    def test_non_arithmetic_no_flag(self, pybind11_cfg):
        enum = TIREnum(name="Color", qualified_name="ns::Color", is_arithmetic=False, values=[TIREnumValue("Red", 0)])
        out = _gen(TIRModule(name="m", enums=[enum]), pybind11_cfg)
...
class TestHashProtocol:
    def _hashable_cls(self):
        return TIRClass(
            name="Key", qualified_name="ns::Key", namespace="ns", variable_name="classKey", generate_hash=True
        )
    ...
    def test_no_hash_without_flag(self, pybind11_cfg):
        cls = TIRClass(
            name="Key", qualified_name="ns::Key", namespace="ns", variable_name="classKey", generate_hash=False
        )
...
class TestFreeFunctionRepr:
    def _setup(self):
        ...
        cls = TIRClass(name="Point", qualified_name="ns::Point", namespace="ns", variable_name="classPoint")
        return cls, fn
...
class TestStringViewMapping:
    ...
    def test_string_view_return_not_suppressed(self, pybind11_cfg):
        ...
        cls = TIRClass(name="Foo", qualified_name="ns::Foo", namespace="ns", variable_name="classFoo", methods=[m])
        out = _gen(TIRModule(name="m", classes=[cls]), pybind11_cfg)
