...
class Generator:
    ...
    def __init__(self, output_config: OutputConfig, generation: GenerationConfig | None = None, extra_unsupported_types: list[str] | None = None, template_extends: str | None = None, typesystem: TypesystemConfig | None = None) -> None: ...
