...
class InputConfig:
    ...
    def format_override_for(self, format_name: str, output_name: str | None = None) -> FormatOverrideConfig | None: ...
...
class OutputConfig:
    ...
    unsupported_types: list[str] = field(default_factory=list)
    template: str = ...
    expand_default_arguments: bool | None = ...
