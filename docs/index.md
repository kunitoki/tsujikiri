...
| [Attributes](attributes.md) | C++ `[[tsujikiri::skip]]`, `[[tsujikiri::keep]]`/`[[tsujikiri::emit]]`, `[[tsujikiri::rename(...)]]`, `[[tsujikiri::doc(...)]]`, `[[tsujikiri::readonly]]`, `[[tsujikiri::thread_safe]]`, `[[tsujikiri::rename_argument(...)]]`, `[[tsujikiri::type_map(...)]]`, `[[clang::annotate("...")]]`; custom attribute handlers; when to use attributes vs YAML |
